...
TELEGRAM_CONFIG = {
    ...
    "authorized_users_file": str(BASE_DIR / "data" / "telegram_scientists_ids.local.json"),
    ...
    "voice_mode_default": "auto",
    "voice_temp_dir": str(BASE_DIR / "tmp" / "telegram_voice"),
    "voice_stt_model": "small",
    "voice_stt_device": "auto",
    "voice_stt_compute_type": "int8",
    "voice_stt_language": "it",
    "voice_stt_beam_size": 1,
    "voice_stt_vad_filter": True,
    "voice_tts_provider": "piper",    # piper | edge_tts | auto | elevenlabs
    "voice_reply_max_chars": 900,
    "voice_caption_limit": 180,
    "voice_download_timeout_sec": 180,
    "voice_piper_default_profile": "it",
    "voice_piper_auto_language": True,
    "voice_piper_model_path": str(BASE_DIR / "models" / "piper" / "it_IT-paola-medium.onnx"),
    "voice_piper_config_path": str(BASE_DIR / "models" / "piper" / "it_IT-paola-medium.onnx.json"),
    "voice_piper_model_url": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/it/it_IT/paola/medium/it_IT-paola-medium.onnx?download=true",
    "voice_piper_config_url": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/it/it_IT/paola/medium/it_IT-paola-medium.onnx.json?download=true",
    "voice_piper_english_model_path": str(BASE_DIR / "models" / "piper" / "en_US-ryan-medium.onnx"),
    "voice_piper_english_config_path": str(BASE_DIR / "models" / "piper" / "en_US-ryan-medium.onnx.json"),
    "voice_piper_english_model_url": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/en/en_US/ryan/medium/en_US-ryan-medium.onnx?download=true",
    "voice_piper_english_config_url": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/en/en_US/ryan/medium/en_US-ryan-medium.onnx.json?download=true",
    "voice_piper_use_cuda": False,
    "voice_elevenlabs_api_key_env": "ELEVENLABS_API_KEY",
    "voice_elevenlabs_voice_id_env": "ELEVENLABS_VOICE_ID",
    "voice_elevenlabs_voice_id": "pNInz6obpgDQGcFmaJgB",
    "voice_elevenlabs_model": "eleven_multilingual_v2",
    "voice_elevenlabs_output_format": "mp3_44100_128",
    "voice_elevenlabs_stability": 0.8,
    "voice_elevenlabs_similarity_boost": 0.85,
    "voice_elevenlabs_style": 0.4,
    "voice_elevenlabs_speaker_boost": True,
    "voice_edge_tts_voice": "it-IT-GiuseppeMultilingualNeural",
    "voice_edge_tts_rate": "-4%",
    "voice_edge_tts_volume": "+8%",
    "voice_edge_tts_pitch": "-8Hz",
    "voice_edge_tts_boundary": "SentenceBoundary",
}
