...
def _add_software_api(pdf: ManualePDF, cfg: dict):
    ...
    pdf._body(
        "Il sistema runtime non include alcun riaddestramento on-device. "
        "Eventuali aggiornamenti del modello sono previsti come workflow "
        "offline tecnico (script in /ai e pipeline dedicate)."
    )
